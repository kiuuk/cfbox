...
class AffiliatesTest < ApplicationSystemTestCase
  ...
  test "creating a Affiliate" do
    ...
    fill_in "Address", with: @affiliate.address
    fill_in "Name", with: @affiliate.name
    fill_in "Password", with: @affiliate.password
    fill_in "Phone", with: @affiliate.phone
    fill_in "Picture", with: @affiliate.picture
    fill_in "Sns", with: @affiliate.sns
    fill_in "Website", with: @affiliate.website
