...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { description: @movement.description, equipment: @movement.equipment, exercise: @movement.exercise, link: @movement.link } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { description: @movement.description, equipment: @movement.equipment, exercise: @movement.exercise, link: @movement.link } }
